  ...
  return (
    <footer className="footer footer-center p-10 bg-gray-400 text-base-content rounded">
      <nav className="grid grid-flow-col gap-4">
        ...
        <Link to="/register" className="link link-hover font-bold text-lg">Register</Link>
      </nav>
      <nav>
      ...
      <aside>
        <p className="font-bold text-lg">Copyright © {year} - All right reserved by The Party Poppers</p>
      </aside>
    </footer>
  );
};
